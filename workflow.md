...
- Создайте новую ветку от текущей рабочей (обычно **develop**).
- Коммитьте небольшие изменения с понятными сообщениями.
- Создайте **Pull Request (PR)**, связанный с задачей.

3. Ревью и завершение:
- При создании **PR** необходимо дать понятный **Title**, коротко описать проделанную работу в **Description** с указанием номера issue
...
<br>
<h2 id="changelog" align="center">Журнализация изменений проекта (Changelog) (надо настроить автоматически)</h2>
<br>
...
<br>
<br>
<h3>Порядок импорта происходит автоматически</h3>
<h3>Порядок написания классов в Tailwind CSS происходит автоматически</h3>
